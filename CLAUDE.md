...
- Use namespaced public env vars in frontend only (e.g., VITE_, EXPO_PUBLIC_) and never commit private keys.
...
- Only expose public keys with VITE_/EXPO_PUBLIC_. Private keys must be proxied via backend.
